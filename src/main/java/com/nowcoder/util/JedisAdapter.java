...
public class JedisAdapter implements InitializingBean {
    ...
    public static void main(String[] args) {
        ...
        jedis.del(listName);
        for (int i = 0; i < 10; ++i) {
            jedis.lpush(listName, "a" + String.valueOf(i));   //从左往右推
        }
    ...
    public boolean sismember(String key, String value) { //判断是否在范围内
        Jedis jedis = null;
        try {
            jedis = pool.getResource();
    ...
    public long scard(String key) {  //有多少个人
        Jedis jedis = null;
        try {
            jedis = pool.getResource();
